...
const projects = [
  {
    ...
    description:
      "A complete mobile platform designed to manage users, tasks, locations, and business operations in real-time.",
    metrics: ["2K+ Users", "99.9% Uptime", "4.8 Rating"],
  },
  {
    category: "Web Application",
    title: "Education Platform",
    description:
      "A responsive digital platform connecting learners, administrators, and educational services seamlessly.",
    metrics: ["5K+ Students", "500+ Courses", "Live Classes"],
  },
  {
    category: "Business Solution",
    title: "Custom Management System",
    description:
      "A customized business application designed to simplify daily operations and improve team productivity.",
    metrics: ["45% Efficiency", "3X Growth", "24/7 Support"],
  },
];
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="p-7">
                  ...
                  <button
                    onClick={() => scrollToSection("contact")}
                    className="mt-6 inline-flex items-center gap-2 font-semibold text-white transition-all group-hover:text-blue-400"
                  >
